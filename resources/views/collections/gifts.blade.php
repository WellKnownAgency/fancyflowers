					...
					<div class="sort pull-right">
							<div class="select">
								...
								<select id="selectProductSort" class="selectProductSort form-control" onchange="location = this.value;">
									...
									<option value="{{ route('collection.gifts', ['sort' => 'low_high']) }}">Lowest First</option>
									<option value="{{ route('collection.gifts', ['sort' => 'high_low']) }}">Highest First</option>
									<option value="{{ route('collection.gifts', ['sort' => 'a_z']) }}">Product Name A-Z</option>
									<option value="{{ route('collection.gifts', ['sort' => 'z_a']) }}">Product Name Z-A</option>
									<option value="{{ route('collection.gifts', ['sort' => 'instock']) }}">In Stock</option>
								</select>
							</div>
					</div>
				</div>
