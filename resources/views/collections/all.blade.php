				...
				<div class="content_sortPagiBar top clearfix">
					<div class="sort pull-right">
						...
						<select id="selectProductSort" class="selectProductSort form-control" onchange="location = this.value;">
							...
							<option value="{{ route('collection.all', ['sort' => 'low_high']) }}">Lowest First</option>
							<option value="{{ route('collection.all', ['sort' => 'high_low']) }}">Highest First</option>
							<option value="{{ route('collection.all', ['sort' => 'a_z']) }}">Product Name A-Z</option>
							<option value="{{ route('collection.all', ['sort' => 'z_a']) }}">Product Name Z-A</option>
							<option value="{{ route('collection.all', ['sort' => 'instock']) }}">In Stock</option>
						</select>
					</div>
				</div>
