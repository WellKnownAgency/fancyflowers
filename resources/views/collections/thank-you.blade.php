					...
					<div class="sort pull-right">
						<div class="select">
							...
							<select id="selectProductSort" class="selectProductSort form-control" onchange="location = this.value;">
								...
								<option value="{{ route('collection.thankyou', ['sort' => 'low_high']) }}">Lowest First</option>
								<option value="{{ route('collection.thankyou', ['sort' => 'high_low']) }}">Highest First</option>
								<option value="{{ route('collection.thankyou', ['sort' => 'a_z']) }}">Product Name A-Z</option>
								<option value="{{ route('collection.thankyou', ['sort' => 'z_a']) }}">Product Name Z-A</option>
								<option value="{{ route('collection.thankyou', ['sort' => 'instock']) }}">In Stock</option>
							</select>
						</div>
					</div>
				</div>
