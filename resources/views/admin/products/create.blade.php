          ...
          <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" name="price1name" class="form-control" id="price1name" placeholder="Price 1 Name">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="price2">Product Price 2 ($)</label>
                <input type="number" name="price2" class="form-control" id="price2" placeholder="Price">
              </div>
              <div class="form-group col-md-6">
                <label for="price2name">Name of the Price 2</label>
                <input type="text" name="price2name" class="form-control" id="price2name" placeholder="Price 2 Name">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="price3">Product Price 3 ($)</label>
                <input type="number" name="price3" class="form-control" id="price3" placeholder="Price">
              </div>
              <div class="form-group col-md-6">
                <label for="price3name">Name of the Price 3</label>
                <input type="text" name="price3name" class="form-control" id="price3name" placeholder="Price 3 Name">
              </div>
            </div>
