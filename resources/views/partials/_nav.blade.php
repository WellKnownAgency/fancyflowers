      ...
      <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-8 col-xs-8">
          <div class="block-callus pull-left hidden-xs">
            <span>Call us now:        <img src="/images/language/en.jpg" alt="" width="16" height="11" style="margin-right:10px;"><a href="tel:+19012204869" style="" class="nav_phone">+1 901 220-4869</a>  /
